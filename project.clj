(defproject mahtable "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "mahtable.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main mahtable.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "mahtable.core/on-figwheel-reload"}

                :compiler {:main mahtable.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/mahtable.js"
